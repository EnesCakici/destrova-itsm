...
export const MANAGER_REPORT_CATEGORIES = [
  { label: "Network", pct: 28 },
  { label: "Identity", pct: 22 },
  { label: "Endpoint", pct: 18 },
  { label: "Microsoft 365", pct: 14 },
  { label: "Print", pct: 9 },
  { label: "Other", pct: 9 },
];

export const MANAGER_REPORT_TREND = [
  { week: "W14", value: 7.2 },
  { week: "W15", value: 6.8 },
  { week: "W16", value: 6.4 },
  { week: "W17", value: 6.5 },
...
export const MANAGER_REPORT_HIGHLIGHTS = [
  { label: "First response", value: "11m", note: "Median across all priorities" },
  { label: "Customer satisfaction", value: "4.6", note: "of 5 · 248 responses" },
  { label: "Reopen rate", value: "3.1%", note: "Last 30 days" },
];

/* ---------------- Reports — historical analysis ---------------- */

/** Date range presets for the Reports page selector. */
...
/** Product / category breakdown for the selected range. */
export const MANAGER_REPORT_PRODUCTS = [
...
/** Agent performance for the selected range. */
export const MANAGER_REPORT_AGENTS = [
...
/** Created vs resolved totals for the selected range — historical. */
export const MANAGER_REPORT_VOLUME = {
  created: 504,
  resolved: 488,
...
/** Available export formats — preview only. */
export const MANAGER_REPORT_EXPORT_FORMATS = ["CSV", "XLSX", "PDF"];
